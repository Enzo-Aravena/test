<?php
	...
	if (!isset($_SESSION['username'])) {
		...
		switch ($evento) {
			...
			break;
			case 'obtenerListaProcedimientos':
				$data = $modelo->OBTENER_LISTA_PROCEDIMIENTO($conn);
				if ($data[0]["data"] == "0") {
					echo "0";
				}else{
					echo json_encode($data);
			...
			case 'obtenerValidaHora':
				$conId = $_REQUEST["conId"];
				$modelo->setConId($conId);
				$data = $modelo->OBTENER_VALIDACION_HORAS_SISTEMA($conn);
				if ($data[0]["data"] == "0") {
					echo "0";
				}else{
					echo json_encode($data);
			...
			case 'ingresarTratamiento': 
				...
				$ObtenerListaindDos1 = $_REQUEST['ObtenerListaindDos1'];
				$ObtenerListaindDos2 = $_REQUEST['ObtenerListaindDos2'];
				$ObtenerListaindDos3 = $_REQUEST['ObtenerListaindDos3'];
				$ObtenerListaindTres1 = $_REQUEST['ObtenerListaindTres1'];
				$ObtenerListaindTres2 = $_REQUEST['ObtenerListaindTres2'];
				$ObtenerListaindTres3 = $_REQUEST['ObtenerListaindTres3'];
			...
			//CASE QUE GUARDA LA NUEVA MOODIFICACION DE LOS DATOS
			case 'ingresarTratamientoModificado':
				$conId = $_REQUEST['conId'];
				$fechaYHoraPantalla = $_REQUEST['fechaYHoraPantalla'];

				// NUEVOS CAMPOS A ENVIAR A LA BASE DE DATOS
				...
				// FIN DE NUEVOS CAMPOS A ENVIAR A LA BASE DE DATOS
				...
				/*======================================= INICIO VALIDACIONES DE CAMPOS NUMERICOS =============================================*/
					...
					// SI EL DATO VIENE EN 0, SE LE ASIGNA UN NULL
					//INICIO VALIDACION DE CAMPOS NUEVOS A ENVIAR A LA BASE 					
					if($ObtenerListaind1 === "0" || $ObtenerListaind1 === "" ){ $ObtenerListaind1 = "NULL"; }else{ $ObtenerListaind1= $ObtenerListaind1; }
					if($ObtenerListaind2 === "0" || $ObtenerListaind2 === "" ){ $ObtenerListaind2 = "NULL"; }else{ $ObtenerListaind2= $ObtenerListaind2; }
					if($ObtenerListaind3 === "0" || $ObtenerListaind3 === "" ){ $ObtenerListaind3 = "NULL"; }else{ $ObtenerListaind3= $ObtenerListaind3; }
					//INICIO VALIDACION DE CAMPOS NUEVOS A ENVIAR A LA BASE 
				...
				$nombreCampos = "TRATAMIENTO_1_IND_1_PROCEDIMIENTO"."|"."TRATAMIENTO_1_IND_2_PROCEDIMIENTO"."|"."TRATAMIENTO_1_IND_3_PROCEDIMIENTO"."|"."TRATAMIENTO_1_IND_1_REALIZADO"."|"."TRATAMIENTO_1_IND_2_REALIZADO"."|"."TRATAMIENTO_1_IND_3_REALIZADO"."|"."TRATAMIENTO_2_IND_1"."|"."TRATAMIENTO_2_IND_2"."|"."TRATAMIENTO_2_IND_3"."|"."TRATAMIENTO_2_IND_1_REALIZADO"."|"."TRATAMIENTO_2_IND_2_REALIZADO"."|"."TRATAMIENTO_2_IND_3_REALIZADO"."|"."TRATAMIENTO_3_IND_1"."|"."TRATAMIENTO_3_IND_2"."|"."TRATAMIENTO_3_IND_3"."|"."TRATAMIENTO_3_IND_1_REALIZADO"."|"."TRATAMIENTO_3_IND_2_REALIZADO"."|"."TRATAMIENTO_3_IND_3_REALIZADO"."|"."HORA_CONTRAL_1"."|"."HORA_CONTRAL_2"."|"."HORA_CONTRAL_3"."|"."HORA_CONTRAL_4"."|"."HORA_CONTRAL_5"."|"."HORA_CONTRAL_6"."|"."FC_1"."|"."FC_2"."|"."FC_3"."|"."FC_4"."|"."FC_5"."|"."FC_6"."|"."FR_1"."|"."FR_2"."|"."FR_3"."|"."FR_4"."|"."FR_5"."|"."FR_6"."|"."T_AUX_1"."|"."T_AUX_2"."|"."T_AUX_3"."|"."T_AUX_4"."|"."T_AUX_5"."|"."T_AUX_6"."|"."SAT_02_1"."|"."SAT_02_2"."|"."SAT_02_3"."|"."SAT_02_4"."|"."SAT_02_5"."|"."SAT_02_6"."|"."HGT_1"."|"."HGT_2"."|"."HGT_3"."|"."HGT_4"."|"."HGT_5"."|"."HGT_6"."|"."PA_SISTOLICA_1"."|"."PA_SISTOLICA_2"."|"."PA_SISTOLICA_3"."|"."PA_SISTOLICA_4"."|"."PA_SISTOLICA_5"."|"."PA_SISTOLICA_6"."|"."PA_DIASTOLICA_1"."|"."PA_DIASTOLICA_2"."|"."PA_DIASTOLICA_3"."|"."PA_DIASTOLICA_4"."|"."PA_DIASTOLICA_5"."|"."PA_DIASTOLICA_6"."|"."E_GLASGOW_1"."|"."E_GLASGOW_2"."|"."E_GLASGOW_3"."|"."E_GLASGOW_4"."|"."E_GLASGOW_5"."|"."E_GLASGOW_6"."|"."E_EVA_1"."|"."E_EVA_2"."|"."E_EVA_3"."|"."E_EVA_4"."|"."E_EVA_5"."|"."E_EVA_6"."|"."OBSERVACIONES"."|". "TRATAMIENTO_2_IND_1_PROCEDIMIENTO"."|"."TRATAMIENTO_2_IND_2_PROCEDIMIENTO"."|"."TRATAMIENTO_2_IND_3_PROCEDIMIENTO"."|"."TRATAMIENTO_3_IND_1_PROCEDIMIENTO"."|"."TRATAMIENTO_3_IND_2_PROCEDIMIENTO"."|"."TRATAMIENTO_3_IND_3_PROCEDIMIENTO"."|";
				$valorCampos = $ObtenerListaind1."|".$ObtenerListaind2."|".$ObtenerListaind3."|". $Realizado1."|".$Realizado2."|".$Realizado3."|".$indDos1."|".$indDos2."|".$indDos3."|".$RealizadoIndDos1."|".$RealizadoIndDos2."|".$RealizadoIndDos3."|".$indTres1."|".$indTres2."|".$indTres3."|".$RealizadoIndTres1."|".$RealizadoIndTres2."|".$RealizadoIndTres3."|".$horaControl1."|".$horaControl2."|".$horaControl3."|".$horaControl4."|".$horaControl5."|".$horaControl6."|".$fcCtr1."|".$fcCtr2."|".$fcCtr3."|".$fcCtr4."|".$fcCtr5."|".$fcCtr6."|".$frCtr1."|".$frCtr2."|".$frCtr3."|".$frCtr4."|".$frCtr5."|".$frCtr6."|".$temAxCtr1."|".$temAxCtr2."|".$temAxCtr3."|".$temAxCtr4."|".$temAxCtr5."|".$temAxCtr6."|".$satOCtr1."|".$satOCtr2."|".$satOCtr3."|".$satOCtr4."|".$satOCtr5."|".$satOCtr6."|".$hgtCtr1."|".$hgtCtr2."|".$hgtCtr3."|".$hgtCtr4."|".$hgtCtr5."|".$hgtCtr6."|".$psCtr1."|".$psCtr2."|".$psCtr3."|".$psCtr4."|".$psCtr5."|".$psCtr6."|".$pdCtr1."|".$pdCtr2."|".$pdCtr3."|".$pdCtr4."|".$pdCtr5."|".$pdCtr6."|".$eGlsCrt1."|".$eGlsCrt2."|".$eGlsCrt3."|".$eGlsCrt4."|".$eGlsCrt5."|".$eGlsCrt6."|".$evaCtr1."|".$evaCtr2."|".$evaCtr3."|".$evaCtr4."|".$evaCtr5."|".$evaCtr6."|".$ObservacionesTto."|".$ObtenerListaindDos1."|".$ObtenerListaindDos2."|".$ObtenerListaindDos3."|".$ObtenerListaindTres1."|".$ObtenerListaindTres2."|".$ObtenerListaindTres3."|";
				...
				$modelo->setNombreCampos($nombreCampos);
				$modelo->setValorCampos($valorCampos);
				$data = $modelo->SP_INSERTAR_OBSERVACION_TRATAMIENTO_MODIFICADO($conn);
				if ($data[0]["data"] == "0") {
					echo "0";
				}else{
					echo json_encode($data);
			...
			case 'validarFinalizacionAtencion':
				$conId = $_REQUEST['conId'];
				$carId = 4;
				$modelo->setConId($conId);
				$modelo->setCarpeta($carId);
				$data = $modelo->SP_VALIDA_SI_PACIENTE_FUE_ATENDIDO($conn);
				echo json_encode($data);
			break;

            ...
            $code .='<div style="border:1px solid black;">';
                $code .='<div style="margin-left:6;margin-right:6;">';
                    ...
                    $code .= '         </label> </td>
                                    ...
                                    <tr>
                                        <td colspan="9" style="border: 1px solid;font-size: 15px;font-weight: bold;"> Manejo y tratamiento indicado en SAPU/SAR :<br> <label style="font-size:13px;font-weight: none;word-wrap: break-word;">';
                                            ...
                                            if($valor["TRATAMIENTO_1_IND_1"] === "" && $valor["TRATAMIENTO_1_IND_2"] === "" && $valor["TRATAMIENTO_1_IND_3"] === "" && $valor["TRATAMIENTO_2_IND_1"] === "" && $valor["TRATAMIENTO_2_IND_2"] === "" && $valor["TRATAMIENTO_2_IND_3"] === "" && $valor["TRATAMIENTO_3_IND_1"] === "" && $valor["TRATAMIENTO_3_IND_2"] === "" && $valor["TRATAMIENTO_3_IND_3"] === ""){
                                                ...
                                                if($valor["TRATAMIENTO_1_IND_1"] !== "" && $valor["TRATAMIENTO_1_IND_2"] !== "" && $valor["TRATAMIENTO_1_IND_3"] !== ""){
                                                    $code.= "<label style='font-weight: bold;'>Indicaciones 1:</label> ".$valor["IND_TTO_1"].":".$valor["TRATAMIENTO_1_IND_1"]." / ".$valor["IND_TTO_2"].":".$valor["TRATAMIENTO_1_IND_2"]." / ".$valor["IND_TTO_3"].":".$valor["TRATAMIENTO_1_IND_3"]."<br>";
                                                }else
                                                    if($valor["TRATAMIENTO_1_IND_1"] !== "" && $valor["TRATAMIENTO_1_IND_2"] === "" && $valor["TRATAMIENTO_1_IND_3"] === ""){
                                                        $code.= "<label style='font-weight: bold;'>Indicaciones 1:</label> ".$valor["IND_TTO_1"].":".$valor["TRATAMIENTO_1_IND_1"]."<br>";
                                                    }else
                                                        if($valor["TRATAMIENTO_1_IND_1"] !== "" && $valor["TRATAMIENTO_1_IND_2"] !== "" && $valor["TRATAMIENTO_1_IND_3"] === ""){
                                                            $code.= "<label style='font-weight: bold;'>Indicaciones 1:</label> ".$valor["IND_TTO_1"].":".$valor["TRATAMIENTO_1_IND_1"]." / ".$valor["IND_TTO_2"].":".$valor["TRATAMIENTO_1_IND_2"]."<br>";
                                                        }

                                                //INDICACIONES 2
                                                if($valor["TRATAMIENTO_2_IND_1"] !== "" && $valor["TRATAMIENTO_2_IND_2"] !== "" && $valor["TRATAMIENTO_2_IND_3"] !== ""){
                                                    $code.= "<label style='font-weight: bold;'>Indicaciones 2:</label> ".$valor["IND_TTO_4"].":".$valor["TRATAMIENTO_2_IND_1"]." / ".$valor["IND_TTO_5"].":".$valor["TRATAMIENTO_2_IND_2"]." / ".$valor["IND_TTO_6"].":".$valor["TRATAMIENTO_2_IND_3"]."<br>";
                                                }else
                                                    if($valor["TRATAMIENTO_2_IND_1"] !== "" && $valor["TRATAMIENTO_2_IND_2"] === "" && $valor["TRATAMIENTO_2_IND_3"] === ""){
                                                        $code.= "<label style='font-weight: bold;'>Indicaciones 2:</label> ".$valor["IND_TTO_4"].":".$valor["TRATAMIENTO_2_IND_1"]."<br>";
                                                    }else
                                                        if($valor["TRATAMIENTO_2_IND_1"] !== "" && $valor["TRATAMIENTO_2_IND_2"] !== "" && $valor["TRATAMIENTO_2_IND_3"] === ""){
                                                            $code.= "<label style='font-weight: bold;'>Indicaciones 2:</label> ".$valor["IND_TTO_4"].":".$valor["TRATAMIENTO_2_IND_1"]." / ".$valor["IND_TTO_5"].":".$valor["TRATAMIENTO_2_IND_2"]."<br>";
                                                        }

                                                //INDICACIONES 3
                                                if($valor["TRATAMIENTO_3_IND_1"] !== "" && $valor["TRATAMIENTO_3_IND_2"] !== "" && $valor["TRATAMIENTO_3_IND_3"] !== ""){
                                                    $code.= "<label style='font-weight: bold;'>Indicaciones 3:</label> ".$valor["IND_TTO_7"].":".$valor["TRATAMIENTO_3_IND_1"]." / ".$valor["IND_TTO_8"].":".$valor["TRATAMIENTO_3_IND_2"]." / ".$valor["IND_TTO_9"].":".$valor["TRATAMIENTO_3_IND_3"]."<br>";
                                                }else
                                                    if($valor["TRATAMIENTO_3_IND_1"] !== "" && $valor["TRATAMIENTO_3_IND_2"] === "" && $valor["TRATAMIENTO_3_IND_3"] === ""){
                                                        $code.= "<label style='font-weight: bold;'>Indicaciones 3:</label> ".$valor["IND_TTO_7"].":".$valor["TRATAMIENTO_3_IND_1"]."<br>";
                                                    }else
                                                        if($valor["TRATAMIENTO_3_IND_1"] !== "" && $valor["TRATAMIENTO_3_IND_2"] !== "" && $valor["TRATAMIENTO_3_IND_3"] === ""){
                                                            $code.= "<label style='font-weight: bold;'>Indicaciones 3:</label> ".$valor["IND_TTO_7"].":".$valor["TRATAMIENTO_3_IND_1"]." / ".$valor["IND_TTO_8"].":".$valor["TRATAMIENTO_3_IND_2"]."<br>";
                                                        }
                    ...
                    if ($valueGes == "1") {
                        $textoPaciente = '"Estimado paciente, su problema de salud puede agravarse. Si esto ocurre, debe volver a consultar en el SAPU/SAR más cercano o en su CESFAM.'."<br>".'En el caso de patologías con garantías explícitas en salud, este dato de atención tiene validez como formulario de constancia e información al paciente GES."';
                    }else{
                    ...
                    $code .='<div style=" margin-left: 0; margin-right: 0;text-align:center !important;">';
                    $code .=' <em> '.$textoPaciente.'</em>';
                    $code .='</div>';

...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />	
  ...
  <meta http-equiv="Pragma" content="no-cache">
	...
	<script src="../controlador/cliente/obsTtoController.js?id=99"></script>
	<script src="js/navObsTto.js?id=98"></script>
	...
	<script type="text/javascript">
		...
		function callEveryHour() {
			setInterval('pruebaUnaHora()', 3600000 );///1000 * 60 * 60 = 3600000
		}*/
					...
					<div class="widget-content padded">
						<form class="form-horizontal" enctype="multipart/form-data" id="detalle">
							...
							<div class="form-horizontal" >
								...
								<input id="horaSistema" name="horaSistema" type="hidden" >
								<input id="horFinal" name="horFinal" type="hidden" >
											...
											<tbody>
												...
												<tr>
													<td>
														...
														Ind. 1: &nbsp;<select style="width: 10em;" id="ObtenerListaind1" name="ObtenerListaind1"></select>
														<input style="width: 25em;" id="ind1" name="ind1" type="text">
														<label><input type="checkbox" id="Realizado1" name="Realizado1"><span class="test"> Realizado </span></label><br>
														Ind. 2: &nbsp;<select style="width: 10em;" id="ObtenerListaind2" name="ObtenerListaind2"></select>
														<input style="width: 25em;" id="ind2" name="ind2" type="text">
														<label><input type="checkbox" id="Realizado2" name="Realizado2"><span> Realizado </span></label><br>
														Ind. 3: &nbsp;<select style="width: 10em;" id="ObtenerListaind3" name="ObtenerListaind3"></select>
														<input style="width: 25em;" id="ind3" name="ind3" type="text">
											...
											<tbody id="manejoYTratamientoDosyTres" style="border-top: none !important;">
												<tr>
													<td id="manejoYttoDos">
														...
														Ind. 1: &nbsp;<select style="width: 10em;" id="ObtenerListaindDos1" name="ObtenerListaindDos1"></select>
														<input style="width: 25em;" id="indDos1" name="indDos1" type="text">
														<label><input type="checkbox" id="RealizadoIndDos1" name="RealizadoIndDos1"><span> Realizado </span></label><br>
														Ind. 2: &nbsp;<select style="width: 10em;" id="ObtenerListaindDos2" name="ObtenerListaindDos2"></select>
														<input style="width: 25em;" id="indDos2" name="indDos2" type="text">
														<label><input type="checkbox" id="RealizadoIndDos2" name="RealizadoIndDos2"><span> Realizado </span></label><br>
														Ind. 3: &nbsp;<select style="width: 10em;" id="ObtenerListaindDos3" name="ObtenerListaindDos3"></select>
														<input style="width: 25em;" id="indDos3" name="indDos3" type="text">
												...
												<tr>
													<td id="manejoYttoDos">
														...
														Ind. 1: &nbsp;<select style="width: 10em;" id="ObtenerListaindTres1" name="ObtenerListaindTres1"></select>
														<input style="width: 25em;" id="indTres1" name="indTres1" type="text">
														<label><input type="checkbox" id="RealizadoIndTres1" name="RealizadoIndTres1"><span> Realizado </span></label><br>
														Ind. 2: &nbsp;<select style="width: 10em;" id="ObtenerListaindTres2" name="ObtenerListaindTres2"></select>
														<input style="width: 25em;" id="indTres2" name="indTres2" type="text">
														<label><input type="checkbox" id="RealizadoIndTres2" name="RealizadoIndTres2"><span> Realizado </span></label><br>
														Ind. 3: &nbsp;<select style="width: 10em;" id="ObtenerListaindTres3" name="ObtenerListaindTres3"></select>
														<input style="width: 25em;" id="indTres3" name="indTres3" type="text">
									...
									<table class="table">
										...
										<tr>
											<td>
												...
												<textarea style="width: 80%;" class="form-control textareaResize" tabindex="6" id="ObservacionesTto" maxlength="700" name="ObservacionesTto" rows="3" cols="3"></textarea><p id="charNum">0/150</p>
											</td>
										</tr>
									</table>
								</div>															
